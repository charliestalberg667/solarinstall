...
export default function Home() {
  ...
  const { title, subtitle, cards, cta } = content[language];
            ...
            {index % 2 === 0 ? (
              ...
              <>
                <div className="space-y-4 md:pr-8">
                  <h2 className="text-3xl font-bold text-center">{card.title}</h2>
                  <p className="text-gray-600 leading-relaxed text-right">{card.description}</p>
