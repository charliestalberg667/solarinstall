...
export default function Model() {
  ...
  function Images(viewport) {
    ...
    const solarPanelTexture = useTexture("/images/solar-panel.png");
    const solarPanelMaterial = new THREE.MeshBasicMaterial({
      map: solarPanelTexture,
    });
    const solarPanelImage = new THREE.Mesh(geometry, solarPanelMaterial);
    solarPanelImage.position.x = 0;
    solarPanelImage.position.y = 0;
    solarPanelImage.position.z = 1;
    solarPanelImage.scale.x = viewport.width / 5;
    solarPanelImage.scale.y = viewport.width / 4;
    group.add(solarPanelImage);
