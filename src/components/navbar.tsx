...
const Navbar = () => {
  ...
  aria-label="Voir l'emplacement de SolarStock sur Google Maps"
>
  <button
    type="submit"
    ...
    aria-label="Explorer le showroom de SolarStock"
  >
    {exploreShowroom}
    <svg
      ...
      aria-hidden="true" // L'icône est décorative, donc on la masque des lecteurs d'écran
    >
      <path
